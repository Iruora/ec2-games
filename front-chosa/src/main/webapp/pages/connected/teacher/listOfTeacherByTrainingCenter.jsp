		...
		<section class="team-grid style-2 tc-padding">
			<div class="container">
				...
				<div class="col-lg-9 col-md-8 col-sm-7">
					...
					<c:forEach var="listValue" items="${listOfTeacherByTrainingCenter}">
						<div
							...
							<div class="team-column style-2 tc-hover">
								...
								<div class="team-detail">
									...
									<a href="${parenturl}/teacher/validateAccount?teacherId=${listValue.tcMemberId }"
										class="btn blue sm pull-left"">Validate</a> 
									<a href="${parenturl}/teacher/bloquedAccount?teacherId=${listValue.tcMemberId }"
