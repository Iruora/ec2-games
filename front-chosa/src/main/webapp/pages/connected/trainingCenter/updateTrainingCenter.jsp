...
<body>
 ...
 <h1 class="visible-lg bg-danger" align="center" style="background-color: red;"> Your training centre not Yet activated .</h1>
					<div class="row">
						...
						<div class="col-sm-8">
							<div class="course-description">
								...
								<form:form id="contact-form" class="row" method="post"
									modelAttribute="connectedTrainingcenter" action="${parenturl}/trainingCenter/update">
					...
					<div class="col-lg-4 col-sm-4 col-xs-6 r-full-width">
							...
							<div class="team-img">
									<img id="profilePicture" src="${parenturl}getTcPicture?centerId=${connectedTrainingcenter.centerId}" />
								</div>
							...
							<input type="hidden" value="${connectedTrainingcenter.centerId }" name="centerId">
