								...
								<div class="related-events-holder z-depth-2">
									...
									<div class="related-events-body">
										<form:form id="contact-form" class="row" method="post"
											...
											action="${parenturl}theme/activity/addUpdate?trainingcenterThemeID=${trainingCenterTheme.tcThemeId}&&${_csrf.parameterName}=${_csrf.token}"
											...
											<div class="col-sm-12 col-xs-12">
												<button class="btn blue z-depth-1 sm pull-right" type="submit">save</button>
												<a class="btn  z-depth-1 sm pull-left" href="${parenturl}theme/activitiesNotAttach?trainingcenterThemeID=${trainingCenterTheme.tcThemeId}">Back</a>
											</div>
