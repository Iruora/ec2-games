...
@ContextConfiguration(classes = { MockUserConfig.class })
...
public class UserServiceTest {
	...
	public void hasRoleTest() {
		...
		Assert.assertEquals(role.getRole(), ROLE.ADMIN);

	}

	@Test
	@WithUserDetails("issam.benbelgacem@esprit.tn")
...
@Ignore("il fau corriger ce point walid")
	...
	public void addUserTest() {
		...
		user.setUserEmail("issam.benbelgacem@esprit.tn");
		;
