		...
		<section class="team-grid style-2 tc-padding">
			...
			<div class="container">
				...
				<div class="col-lg-6 col-md-8 col-sm-7">
						...
						<a
							href="${parenturl}theme/activities?trainingcenterThemeID=${trainingCenterTheme.tcThemeId}&&programId=${program.tcProgramId}&&role=teacher"
				...
				<div class="col-lg-6 col-md-8 col-sm-7">
					...
					<c:if test="${document eq null}">
						...
						<iframe width="854" height="480"
							src="https://www.youtube.com/embed/${trainingCenterActivity.urlVideo.split('v=')[1].split('&')[0]}"
