                 ...
                 <tr>
					<td>
						<table border="0" cellpadding="0" cellspacing="0" width="100%"
							...
							<tbody style="width: 100%; max-width: 600%">
								<tr>
									<td><center><h2 >[CHOSA] Request to confirm your email address </h2></center></td>
								</tr>
							</tbody>
						</table>
					</td>
										...
										<table class="m_-3335448033320000562simple" cellpadding="0"
											...
											<tbody>
												<tr>
													...
													<p >
														<!-- DEBUT DU MESSAGE --> 
														<center style = "line-height: 170%;"><p>Thank you for your account opening request</p><b><a href="http:// chosa.com" style="font-family:'Open Sans',sans-serif; font-size: 13px; font-weight: 300; line-height: 1.6; color:#00b4e6 ;text-decoration:none;"> chosa.com </a></b> <p> In order to activate your account, please confirm that you are the</p><p> owner of this email address in
														 <a href="${link}" style="font-family:'Open Sans',sans-serif; font-size: 13px; font-weight: 300; line-height: 1.6; color:#00b4e6 ;text-decoration:none;"> clicking on this link .</a></p><br> <p> Thank you for your trust, <strong> The chosa team.</strong></p></center>
														<!-- FIN DU MESSAGE-->
														</p>
													</td>
												</tr>
