															...
															<div class="modal-content">
																...
																<div class="modal-body">
                                                                   ...
                                                                   <div class="form-group">
																		...
																		<option value="${tCenter.country.id}">${tCenter.country.name}</option>
									...
									<div class="dataTables_paginate paging_simple_numbers">
										<ul class="pagination">	
											...
											<li class="paginate_button previous"><a
												href="${parenturl}admin/centers?page=${page-1}"> previous</a>
											</li>
											</c:when>
											</c:choose>
											<c:choose>
										<c:when test="${page < maxNumberPage}">	
											...
											<a href="${parenturl}admin/centers?page=${page+1}">Next</a>
											</li>
                                        </c:when>
