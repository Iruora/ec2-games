					...
					<div class="row">
								...
								<div class="related-events-holder z-depth-2">
									...
									<div class="related-events-body">
										<form:form id="contact-form" class="row" method="post"
											modelAttribute="user"
											action="${parenturl}family/membres/update?${_csrf.parameterName}=${_csrf.token}&&failyMemberID=${familyMember.familyMemberId}"
						...
						<div class="col-lg-4 col-sm-4 col-xs-6 r-full-width">
							<div class="team-column style-2 tc-hover">
								...
								<form method="post"
									action="${parenturl}user/updatePicture?${_csrf.parameterName}=${_csrf.token}&&idFamily=${familyMember.familyMemberId}"
									enctype="multipart/form-data">
