		...
		<section class="team-grid style-2 tc-padding">
			<div class="container">
								...
								<div class="related-events-holder z-depth-2">
									...
									<div class="related-events-body">
										<form:form id="contact-form" class="row" method="post"
											...
											action="${parenturl}/trainingCenter/activity/addUpdate">
				...
				<div class="col-lg-4 col-sm-4 col-xs-6 r-full-width">
					...
					<form method="post"
						action="${parenturl}activity/addDocument?${_csrf.parameterName}=${_csrf.token}&&idActivity=${trainingCenterActivity.tcActivityId }"
						enctype="multipart/form-data">
						<%-- <input type="hidden" value="${trainingCenterActivity.tcActivityId }"
								name="idActivity"> --%>
						...
						<div class="team-detail">
							...
							<div class="col-md-12">
								<div class="form-group label-floating">
									<h4>upload File</h4>
									<input type="file" class="form-control" name="activitydocument" />
								</div>
							</div>
						</div>
						<div class="col-sm-12 col-xs-12">
