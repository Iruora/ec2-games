								...
								<div class="related-events-holder z-depth-2">
									...
									<div class="related-events-body">
										<form:form id="contact-form" class="row" method="post"
											...
											action="${parenturl}trainingCenter/activity/addUpdate?${_csrf.parameterName}=${_csrf.token}"
											...
											<div class="col-sm-6 col-xs-4 r-full-width">
												<div class="form-group">
													...
													<label class="control-label">Url Video</label><i
														class="bar"></i>
												</div>
											</div>
											<div class="col-sm-2 col-xs-4 r-full-width">
												<div class="form-group">
											...
											<div class="col-md-8">
												<div class="form-group label-floating">
													<form:textarea path="descriptionActivity" type="text" />
