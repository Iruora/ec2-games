	...
	<div class="container">
		...
		<div class="address-list-top">
			<ul>
				...
				<li><a href="?lang=fr" style="display: inline-block;"><img
						src="${parenturl}static/theme/theme/images/icon-french.png" alt=""></a></li>
				<li><a href="?lang=en" style="display: inline-block;"><img
						src="${parenturl}static/theme/theme/images/icon-english.png"
						alt=""></a></li>
			</ul>
		</div>
		<!-- Address List -->
...
<div class="nav-holder style-2 z-depth-1">
	<div class="container">
		...
		<div class="nav-list">
			...
			<li>
					<a
					href="javascript:logout()">Training Center</a>
				</li>
				<li
					<c:if test="${existSpeciality == 'Psychologie'}"> class="active"</c:if>>
					<a
					href="${parenturl}family/profil">Family</a>
				</li>
			</ul>
		</div>
		<!-- Navigation -->
