		...
		<section class="team-grid style-2 tc-padding">
			<div class="container">
				...
				<div class="col-lg-9 col-md-8 col-sm-7">
					...
					<section class="team-grid style-2 tc-padding">
					<c:forEach var="listValue" items="${listOfTrainingCenterSubscribeByMember}">
						<div
							...
							<div class="team-column style-2 tc-hover">
								...
								<div class="team-detail">
									<h3>${listValue.trainingCenter.name}</h3>

									<p>${listValue.trainingCenter.adress}</p>
									<p>${listValue.trainingCenter.manager.userEmail}</p>
									<p>${listValue.trainingCenter.manager.userName}</p>
									<!-- <a
										
										class="btn blue sm  ">inf</a> -->
