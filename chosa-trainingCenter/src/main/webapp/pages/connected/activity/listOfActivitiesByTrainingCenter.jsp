		...
		<section class="team-grid style-2 tc-padding">
			<div class="container">
				...
				<div class="col-lg-9 col-md-8 col-sm-7">
					...
					<!-- Teachers -->
						<section class="team-grid style-2 tc-padding">
						<c:forEach var="listValue" items="${listOftrainingCenterActity}">
								...
								<div class="team-column style-2 tc-hover">
									...
									<div class="team-detail">
										...
										<a 
											...
											class="btn col-md-2 pull-left btn btn-info sm ">update</a>
											
											<a 
											href="${parenturl}trainingCenter/program/theme/activityDelete?trainingcenterActivityID=${listValue.tcActivityId}"
											class="btn col-md-2 pull-right btn btn-danger sm ">delete</a>
											</div>
