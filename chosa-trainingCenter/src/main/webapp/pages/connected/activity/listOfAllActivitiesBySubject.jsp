			...
			<div class="container">
				...
				<div class="col-lg-9 col-md-8 col-sm-7">
					...
					<div class=" row col-md-offset-1">
						<a class="btn col-md-2 sm z-depth-1 "
							href="${parenturl}trainingCenter/activitiesBysubject?subject=LOGIC">Logic</a>
						<a class="btn col-md-2 sm z-depth-1 "
							href="${parenturl}trainingCenter/activitiesBysubject?subject=VISUEL">Visuel</a>
						<a class="btn col-md-2 sm z-depth-1 "
							href="${parenturl}trainingCenter/activitiesBysubject?subject=SCIENCE">Science</a>
						<a class="btn col-md-2 sm z-depth-1 "
							href="${parenturl}trainingCenter/activitiesBysubject?subject=LANGUAGE">Language</a>
						<a class="btn col-md-2 sm z-depth-1 "
							href="${parenturl}trainingCenter/activitiesBysubject?subject=SOCIAL">Social</a>
					</div>
					<!-- Teachers -->
					<section class="team-grid style-2 tc-padding">
						<c:forEach var="listValue"
							items="${listOfAlltrainingCenterActityBysubject}">
							...
							<div
								...
								<div class="team-column style-2 tc-hover">
									...
									<div class="team-detail">
										...
										<h5>${listValue.minNumber}-${listValue.maxNumber}
											Students</h5>
