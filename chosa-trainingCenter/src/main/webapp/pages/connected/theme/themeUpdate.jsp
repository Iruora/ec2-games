								...
								<div class="related-events-holder z-depth-2">
									...
									<div class="related-events-body">
										<form:form id="contact-form" class="row" method="post"
											modelAttribute="trainingCentertheme" action="${parenturl}trainingCenter/program/theme/add?trainingcenterProgramID=${trainingcenterProgramID}">
											
												<div class="col-sm-8 col-xs-4 r-full-width">
													<div class="form-group">
														<form:input path="themeName" type="text" />
														<label class="control-label">Theme</label><i
															class="bar"></i>
													</div>
												</div>
												...
												<div class="col-sm-8 col-xs-4 r-full-width">
													<div class="form-group">
														<form:input path="themeDescription" type="text" />
														<label class="control-label">Description</label><i
															class="bar"></i>
													</div>
												</div>
												<div class="col-sm-8 col-xs-4 r-full-width">
													<div class="form-group">
														<form:input path="themeOrdre" type="text" />
														<label class="control-label">Ordre</label><i
															class="bar"></i>
													</div>
												</div>
											<form:hidden path="tcThemeId"/>
