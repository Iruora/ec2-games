package com.atn.demo.mvc.module.fileController;
...
public class FileController {
	...
	public ModelAndView setUserPicture(
		...
		model.setViewName("redirect:/trainingCenter/member/invite?roleMember=TEACHER");
		} else if (roleMember.equals("STUDENT")) {
			model.setViewName("redirect:/trainingCenter/member/invite?roleMember=STUDENT");
		}
		return model;
	}
